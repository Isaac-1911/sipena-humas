                ...
                <div class="news-card">
                    ...
                    <div class="news-content">
                        ...
                        <div class="news-actions">
                            <a href="{{ route('admin.news.show', $item->id) }}" class="action-btn view-btn"
                                title="Lihat Detail">
                                <i class="bi bi-eye"></i>
                                <span>Lihat</span>
                            </a>

                            <a href="{{ route('admin.news.edit', $item->id) }}" class="action-btn edit-btn"
                                title="Edit Berita">
            ...
            <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" id="newsForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" class="form-control modern-input"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="content" class="form-control modern-textarea" rows="6"
