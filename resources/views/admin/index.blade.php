                    ...
                    <div class="activity-list">
                        @foreach ($activities as $activity)
                            <div class="activity-item">
                                <div
                                    class="activity-icon {{ get_class($activity) === \App\Models\News::class ? 'icon-blue' : 'icon-yellow' }}">
                                    <i
                                        class="bi {{ get_class($activity) === \App\Models\News::class ? 'bi-newspaper' : 'bi-archive' }}"></i>
                                </div>
